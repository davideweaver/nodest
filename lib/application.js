...
/**
  ...
  * @class
	...
	* @param {Nodest.WebService} WebService Class to use for the application's web service
	* @param {Nodest.Extension[]} extensions Array of extensions for application to use
  */
class Application {
	constructor(pathContext, WebService, extensions) {
	...
	*/
	__init() {
		...
		this.koa = this.webservice.create();
